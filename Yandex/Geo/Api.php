...
//            ->useAreaLimit(false);
    ...
    public function resetAreaBoxLimit()
    {
        unset($this->_filters['bbox']);
        unset($this->_filters['rspn']);
    }

    public function setAreaBoxLimit($areaLimit)
    {
        $this->_filters['bbox'] = (string) $areaLimit;
        $this->_filters['rspn'] = 1;
        return $this;
    }
